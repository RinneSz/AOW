...
class AbstractDistillationDataset(metaclass=ABCMeta):
    ...
    def _get_subfolder_path(self):
        ...
        return root.joinpath(self.bb_model_code + '_' + str(self.args.num_generated_seqs) + '_' + str(self.args.number_ood_seqs) + '_' + str(self.args.number_ood_val_seqs) + '_' + str(self.args.pattern_len) + '_' + str(self.args.method) + '_' + str(self.args.bottom_m))
